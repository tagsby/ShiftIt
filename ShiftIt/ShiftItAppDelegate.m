...
- (void) initializeActions_ {
	...
	ShiftItAction *sizel = [[ShiftItAction alloc] initWithIdentifier:@"sizel" label:@"Size Left" uiTag:11 action:&ShiftIt_SizeL];
	[dict setObject:sizel forKey:[sizel identifier]];
	ShiftItAction *sizer = [[ShiftItAction alloc] initWithIdentifier:@"sizer" label:@"Size Right" uiTag:12 action:&ShiftIt_SizeR];
	[dict setObject:sizer forKey:[sizer identifier]];
	ShiftItAction *sizeu = [[ShiftItAction alloc] initWithIdentifier:@"sizeu" label:@"Size Up" uiTag:13 action:&ShiftIt_SizeU];
	[dict setObject:sizeu forKey:[sizeu identifier]];
	ShiftItAction *sized = [[ShiftItAction alloc] initWithIdentifier:@"sized" label:@"Size Down" uiTag:14 action:&ShiftIt_SizeD];
	[dict setObject:sized forKey:[sized identifier]];
